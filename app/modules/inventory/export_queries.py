...
EXPORT_QUERIES.update({
    ...
    "reporte_aptot": (
        """
        SELECT
            c.source_kind AS "source kind",
            c.source_ref_id AS "source ref id",
            ...
            c.state,
            c.inv_sit AS "inv sit",
            c.inv_con AS "inv con",
            c.mar_npri AS "mar npri",
            c.mar_num AS "mar num",
            c.mar_ccat AS "mar ccat",
            c.mar_des AS "mar des",
            c.mar_esp AS "mar esp",
            c.mar_est AS "mar est",
            c.mar_uso AS "mar uso",
            c.mar_seg AS "mar seg",
            c.mar_col AS "mar col",
            c.mar_mar AS "mar mar",
            c.mar_mod AS "mar mod",
            c.mar_tip AS "mar tip",
            c.mar_ser AS "mar ser",
            c.mar_med AS "mar med",
            c.mar_npla AS "mar npla",
            c.mar_nmot AS "mar nmot",
            c.mar_ncha AS "mar ncha",
            c.mar_obs AS "mar obs",
            c.inv_num_1 AS "inv num 1",
            c.inv_num_2 AS "inv num 2",
            c.inv_num AS "inv num",
            c.item_created_at AS "item created at",
            c.item_updated_at AS "item updated at",
            c.hoj_num AS "hoj num",
            c.hoj_fec AS "hoj fec",
            c.area_code AS "area code",
            c.area_description AS "area description",
            c.ambiente_code AS "ambiente code",
            c.ambiente_description AS "ambiente description",
            c.ambiente_piso AS "ambiente piso",
            c.ambiente_piso_des AS "ambiente piso des",
            c.local_description AS "local description",
            c.local_code AS "local code",
            c.local_departamento AS "local departamento",
            c.usuario_code AS "usuario code",
            c.usuario,
            c.fecha_margesi AS "fecha margesi",
            c.doc_margesi AS "doc margesi",
            c.cuenta_margesi AS "cuenta margesi",
            c.valor_margesi AS "valor margesi",
            c.margesi_sbn AS "margesi sbn",
            c.margesi_area AS "margesi area",
            c.margesi_departamento AS "margesi departamento",
            c.margesi_local AS "margesi local",
            c.margesi_ambiente AS "margesi ambiente",
            c.margesi_usuario AS "margesi usuario",
            c.margesi_description AS "margesi description",
            c.margesi_marca AS "margesi marca",
            c.margesi_modelo AS "margesi modelo",
            c.margesi_tipo AS "margesi tipo",
            c.margesi_serie AS "margesi serie",
            c.margesi_cod_local AS "margesi cod local",
            c.local_id AS "local id",
            c.margesi_obs AS "margesi obs",
            c.local_libre AS "local libre",
            c.ccosto_libre AS "ccosto libre",
            c.ambiente_libre AS "ambiente libre",
            c.usuario_libre AS "usuario libre",
